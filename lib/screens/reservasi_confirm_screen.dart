// lib/screens/reservasi_confirm_screen.dart
...
class ReservasiConfirmScreen extends StatelessWidget {
  ...
  // Helper untuk mendapatkan referensi reservasi unik
  String _generateRefNumber(DateTime dt) {
    // Format: RES + YYMMDDHHMMSS (15 digit)
    return 'RES${DateFormat('yyMMddHHmmss').format(dt)}'; 
  }

  // Widget Pembantu untuk Box Informasi Kecil
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              if (icon != null) Icon(icon, size: 16, color: Colors.orange.shade700),
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  // Detail Reservasi (Mirip Resi)
                  Row(
                    children: [
                      Expanded(child: _buildInfoBox('Kode Reservasi', refNumber)),
                      const SizedBox(width: 15),
                      Expanded(child: _buildInfoBox('Tipe Meja', reservasiData['tableType'])),
                    ],
                  ),
                  const SizedBox(height: 15),
                  ...
                  Row(
                    children: [
                      Expanded(
                          child: _buildInfoBox(
                            'Waktu Kedatangan', 
                            DateFormat('d MMM, HH:mm').format(reservasiData['selectedDateTime']),
                  ...
                  _buildInfoBox('Nama Pemesan', reservasiData['name'], icon: Icons.person),
                  const SizedBox(height: 15),
                  _buildInfoBox('Kontak', reservasiData['phone'], icon: Icons.phone),
                  ...
                  // Tombol Done (Kembali ke Home)
                  ElevatedButton(
                    onPressed: () {
                      // Kembali ke halaman utama (MainNavigationShell)
