...
class ContactUsScreen extends StatelessWidget {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildHourRow('Monday - Sunday', '10.00 - 22.00 WIB',
                isClosed: false),
          ],
        ),
      ),
              ...
              child: Column(
                children: [
                  Row(
                    children: [
                      Expanded(
                          child: _buildFormTextField('Name', required: true)),
                      const SizedBox(width: 15),
                      Expanded(
                          child: _buildFormTextField('Email',
                              required: true,
                              keyboardType: TextInputType.emailAddress)),
                    ],
                  ),
                  const SizedBox(height: 15),
                  _buildFormTextField('Subject',
                      hint: 'What can we help you with?'),
                  const SizedBox(height: 15),
                  _buildFormTextField(
                    'Message',
                    hint:
                        'Tell us about your inquiry, feedback, or special requests...',
                    maxLines: 4,
                    required: true,
                  ),
                ...
                Wrap(
                  ...
                  children: [
                    _buildSocialButton('Instagram', Icons.camera_alt,
                        'https://instagram.com/laparspace'),
                    _buildSocialButton('Facebook', Icons.facebook,
                        'https://facebook.com/laparspace'),
                    _buildSocialButton('Twitter', Icons.ac_unit,
                        'https://twitter.com/laparspace',
                        icon: Icons.person),
                  ],
                ),
                const SizedBox(height: 15),
  ...
  Widget _buildSocialButton(String label, IconData defaultIcon, String url,
      {IconData? icon}) {
                  ...
                  child: const Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 5),
                        Text('Interactive Map (123 Culinary Street)',
