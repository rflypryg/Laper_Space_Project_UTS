...
class ReceiptScreen extends StatelessWidget {
  ...
  Widget _buildSummaryBox(String label, double amount,
  ...
  Widget _buildOrderItemsList(List<CartItem> items) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text('Daftar Item Dipesan:',
            style: TextStyle(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Expanded(
                              child:
                                  _buildSummaryBox('Subtotal Item', subtotal)),
                          const SizedBox(width: 15),
                          Expanded(
                              child: _buildSummaryBox('PPN (10%)', tax,
  ...
  Widget _buildDetailRowCard(
      String refNumber, String paymentTime, String method, String option) {
    return Column(
      children: [
        Row(
          children: [
